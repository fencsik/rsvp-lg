...
rsvpCols2Keep = c("exp", "ver", "sub", "experimenter", "blocktyp", "sess",
                  ...
                  "t1_rt", "t2_rt")
survCols2Keep = c("progress", "duration..in.seconds.", "finished", "sub",
                  ...
                  "promisa8", "age", "gender", "gender_6_text")
...
```{r savedata}
write.csv(rsvpDataAnon, "RSVPLG01-Experiment-Anon.csv",
          row.names=FALSE)
write.csv(surveyDataAnon, "RSVPLG01-Survey-Anon.csv",
          row.names=FALSE)
```
